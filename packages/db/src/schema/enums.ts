...
export const claimEventTypeEnum = pgEnum('claim_event_type', ['fact', 'observation', 'action', 'system', 'evidence_requested', 'approved', 'denied', 'callback_requested', 'upsell_attempted']);
